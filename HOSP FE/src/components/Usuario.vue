        ...
        <div class="container_Usuario_user">
            <form v-on:submit.prevent="processSignUp">
                ...
                <label id="user_perfil"> 
                    <input type="text" v-model="user.username" placeholder="Perfil" required>
                </label>
                </label>
                <label id="user_nombres">
                    <input type="text" v-model="user.name" placeholder="Nombres" required>
                </label>
                <label id="user_apellidos"> 
                    <input type="text" v-model="user.email" placeholder="Apellidos" required>
                </label>
                <label id="user_telefono"> 
                    <input type="text" v-model="user.account.balance" placeholder="Telefono" required>
                </label>
                <label id="user_genero"> 
                    <input type="text" v-model="user.account.balance" placeholder="Genero" required>
                </label>
