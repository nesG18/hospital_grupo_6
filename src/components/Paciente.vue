        ...
        <div class="container_Paciente_user">
            <form v-on:submit.prevent="processSignUp">
                <label id="user_Direccion"> 
                    <input type="text" v-model="user.Direccion" placeholder="Direccion" required>
                </label>
                <label id="user_Ciudad"> 
                    <input type="text" v-model="user.Ciudad" placeholder="Ciudad" required>
                </label>
                <label id="user_FechaNacimiento"> Fecha de Nacimiento:
                    <input type="date" v-model="user.user_FechaNacimiento" placeholder="Fecha de nacimiento" required>
                </label>
